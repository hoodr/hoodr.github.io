  ...
  return (
    <div className="slides-container">
      <div className="carousel">
        ...
        <button className="carousel_control carousel_control__prev" onClick={prev}><span></span></button>
        <button className="carousel_control carousel_control__next" onClick={next}><span></span></button>
